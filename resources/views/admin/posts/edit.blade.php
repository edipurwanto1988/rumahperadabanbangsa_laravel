    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Update post information and content.
            </p>
        </div>
    ...
    <x-admin-card title="Post Information">
        ...
        <form id="post-form" action="{{ route('admin.posts.update', $post) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-1">
                    <textarea id="description" name="description" rows="2" maxlength="160"
                        ...
                        placeholder="Brief description of the post (max 160 characters)...">{{ old('description', $post->description) }}</textarea>
                </div>
            ...
            <x-admin-category-selector
                label="Categories"
                name="categories[]"
                :value="old('categories', $post->categories->pluck('id')->toArray())"
            ...
            <div class="flex items-center justify-end space-x-3">
                <x-admin-button variant="secondary" href="{{ route('admin.posts.show', $post) }}">
                    Cancel
                </x-admin-button>
