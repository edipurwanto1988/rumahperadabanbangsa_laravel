...
@section('content')
<div class="space-y-6" x-data="menuCreator()">
    <!-- Page Header -->
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add New Menu</h1>
    ...
    <x-admin-card title="Menu Information">
        <form action="{{ route('admin.menus.store') }}" method="POST" class="space-y-6" x-ref="menuForm">
            @csrf
