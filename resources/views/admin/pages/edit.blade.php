...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Page</h1>
    ...
    <x-admin-card title="Page Information">
        ...
        <form id="page-form" action="{{ route('admin.pages.update', $page) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-1">
                    <textarea id="description" name="description" rows="2"
                        ...
                        placeholder="Brief description for SEO (max 160 characters)..." maxlength="160">{{ old('description', $page->description) }}</textarea>
                </div>
            ...
            <div class="flex items-center justify-end space-x-3">
                <x-admin-button variant="secondary" href="{{ route('admin.pages.show', $page) }}">
                    Cancel
                </x-admin-button>
